...
import TTMLogo from "../../public/icons/ttm-logo.svg";
...
function Logo({ t }) {
  ...
  if (locale !== "ru") {
    socialLinks = [
      { href: "https://www.youtube.com/@texttreemovement", Icon: Youtube },
    ];
  }
  ...
  return (
    <div className="flex flex-col w-full gap-6 md:gap-14">
      ...
      <div className="flex items-center gap-5 md:gap-10 flex-col md:flex-row">
        <Link href="https://www.texttree.org" target="_blank" legacyBehavior>
          <a>
            <TTMLogo />
          </a>
        </Link>
        ...
        <div className="flex justify-center items-center gap-3">
          {socialLinks.map(({ href, Icon, size }, index) => (
            <Link href={href} key={index} target="_blank" legacyBehavior>
              <a
