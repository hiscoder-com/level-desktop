    ...
    <>
      <main className="hidden md:flex mx-auto max-w-6xl w-full h-[84vh] max-h-[40rem] lg:max-h-[40rem] xl:max-h-[50rem] 2xl:max-h-[56.4rem] text-xl font-bold px-5 lg:px-16 xl:px-20 2xl:px-0">
        ...
        <section className="w-1/2 px-1 text-white">
          <div
            className={`${
              contentKey ? "hidden" : "flex"
            } h-full gap-4 xl:gap-7`}
          >
            <div className="flex flex-col justify-between w-1/2 gap-4 xl:gap-7">
              <div
                className="p-5 lg:p-7 h-1/2 bg-th-secondary-200 rounded-2xl bg-[url('../public/images/about.jpg')] bg-cover bg-no-repeat grayscale transform transition duration-300 hover:scale-105 hover:grayscale-0 cursor-pointer"
                onClick={() => setContentKey("intro")}
                dangerouslySetInnerHTML={{
                  __html: t("MainBlocks.WhatIsVcana"),
                }}
              ></div>

              <div
                className="p-5 lg:p-7 h-1/2 bg-th-secondary-200 rounded-2xl bg-[url('../public/images/reviews.jpg')] bg-cover bg-no-repeat grayscale transform transition duration-300 hover:scale-105 hover:grayscale-0 cursor-pointer"
            ...
            <div className="flex flex-col justify-between w-1/2 gap-4 xl:gap-7">
              <div
                className="p-5 lg:p-7 h-1/2 bg-th-secondary-200 rounded-2xl bg-[url('../public/images/inside.jpg')] bg-cover bg-no-repeat grayscale transform transition duration-300 hover:scale-105 hover:grayscale-0 cursor-pointer"
              ...
              <div
                className="p-5 lg:p-7 h-1/2 bg-th-secondary-200 rounded-2xl bg-[url('../public/images/faq.jpg')] bg-cover bg-no-repeat grayscale transform transition duration-300 hover:scale-105 hover:grayscale-0 cursor-pointer"
      ...
      <main className="flex md:hidden flex-col gap-5 p-5 font-medium text-lg">
        ...
        >
          <div
            className={`absolute inset-0 bg-[url("../public/images/about-mobile.jpg")] bg-cover bg-no-repeat transition-opacity duration-500 ${
        ...
        >
          <div
            className={`absolute inset-0 bg-[url("../public/images/inside-mobile.jpg")] bg-cover bg-no-repeat transition-opacity duration-500 ${
        ...
        >
          <div
            className={`absolute inset-0 bg-[url("../public/images/reviews-mobile.jpg")] bg-cover bg-no-repeat transition-opacity duration-500 ${
        ...
        >
          <div
            className={`absolute inset-0 bg-[url("../public/images/faq-mobile.jpg")] bg-cover bg-no-repeat transition-opacity duration-500 ${
        ...
        <div className="grid grid-cols-2 gap-5 text-center">
          {!showSections.signIn && (
            ...
            >
              <p
                className={`uppercase ${
                  showSections.demo ? "font-semibold" : ""
                }`}
              >
                {t("Demo")}
              </p>
          ...
          {!showSections.demo && (
            ...
            >
              <p
                className={`${showSections.signIn ? "mb-5 font-semibold" : ""}`}
              >
                {showSections.signIn
                  ? t("users:LoginToAccount")
                  : t("users:SignIn")}
              </p>
            </div>
          )}
