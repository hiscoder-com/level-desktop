    ...
    <>
      ...
      <div className="text-lg w-full p-4">
        ...
        <p>
          Работать будет так.
          <br />
          1ым шагом мы загружаем файл с конфигом, где прописаны будут все шаги и т.д.
          <br />
          2ой шаг - это указать ссылки на ресурсы
          <br />
          3ий шаг - указать код книги, для которой мы создаем пакет
          <br />
          После этого надо нажать кнопку "Сгенерировать", и у нас получится архив со всеми
          настройками и файлами
        </p>
        <form onSubmit={onSubmit}>
          ...
          <input className="btn-primary text-base mt-3" type="submit" value={'Create'} />
        </form>
      </div>
    </>
  )
